...
//
//         Line.segmentCount = (Line.segmentCount || 0) + 1;
//
//         this.hasLightstreet = Math.random() < 0.3;  // 10% chance for a Lightstreet to appear on a segment
//         this.lightstreetOffset = (Math.random() - 0.5) * width / 2; // Random position offset between [-width/4, width/4]
//     }
// }
//
// function drawLightstreet(element, image, x, y, width, height) {
...
//     element.style.zIndex = 1000; // Ensure it's rendered above other items
// }
//
// class Car {
...
//
//         //for random lightstreet
//         if (l.hasLightstreet) {
//             let even = ((n / 2) | 0) % 2;
//             let grassWidth = width / 4;
//             let xPositionLeft = l.lightstreetOffset; // Position on the left grass
//             let xPositionRight = width - l.lightstreetOffset - ASSETS.IMAGE.LIGHTSTREET.width; // Position on the right grass
//             let yPosition = l.Y;
//
//             // Randomly decide left or right
//             let xPosition = Math.random() < 0.5 ? xPositionLeft : xPositionRight;
//
//             drawLightstreet(
//                 l.elements[6], // You might want to increase the index if there are more elements
//                 ASSETS.IMAGE.LIGHTSTREET.src,
//                 xPosition,
//                 yPosition,
//                 ASSETS.IMAGE.LIGHTSTREET.width,
//                 ASSETS.IMAGE.LIGHTSTREET.height
//             );
//         }
//
//
